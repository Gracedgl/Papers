...
\AuthorsForCitationInfo{William Curran}

%\TitleForCitationInfo{Extending the Difference Reward to Multi-Objective Reinforcement Learning}

\title{Developing Learning and Multi-Robot Coordination Techniques for Individuals with Physical Disabilities (Doctoral Consortium)}

\TitleForCitationInfo{Developing Learning and Multi-Robot Coordination Techniques for Individuals with Physical Disabilities (Doctoral Consortium)}
...
William Curran\\
       ...
       \affaddr{curranw@onid.oregonstate.edu}
%\alignauthor
%Bill Smart\\
%       \affaddr{Oregon State University}\\
%       \affaddr{Corvallis, Oregon}\\
%       \affaddr{smartw@onid.oregonstate.edu}
%\alignauthor 
%Kagan Tumer\\
%       \affaddr{Oregon State University}\\
%       \affaddr{Corvallis, Oregon}\\
...
\keywords{Human-Robot Interaction, Learning from Demonstration, Shared Autonomy}
